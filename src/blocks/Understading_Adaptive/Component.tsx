...
interface UnderStandingAdaptiveProps {
    ...
    fa_sub_desc?: FactorAnalysisSubDesc[]
    basket_title?: PayloadRichText
    basket?: BasketItem[]
}

export const UnderStandingAdaptive: React.FC<UnderStandingAdaptiveProps> = ({ title, factor_analysis_desc, fa_sub_desc, basket_title, basket }) => {
